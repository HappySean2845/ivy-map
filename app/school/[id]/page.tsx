  ...
  return (
    <main className="mx-auto max-w-3xl px-4 pb-16 sm:px-6">
      ...
      <header className="mt-4">
        <p className="font-serif text-xs tracking-widest text-ink-muted">IVY MAP · 学校档案</p>
        <h1 className="mt-2 font-serif text-2xl leading-snug sm:text-3xl">{school.nameCn}</h1>
