...
| 项 | 何时定 |
|---|---|
| ~~中国地图 GeoJSON 的具体来源与边界核对~~ | ✅ **已解决**（见下） |
...
- **落地**：`public/geo/china.json`
- **内容**：34 个省级行政区（含台湾省、香港特别行政区、澳门特别行政区）+ 南海诸岛
- **边界**：符合国家标准

这一条原本排在 §9.1 的合规风险里，现在闭合了。**换文件前必须重新做一次边界人工确认**——这是合规事故的高发点，不是技术选型问题。
